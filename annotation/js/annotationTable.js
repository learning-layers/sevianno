...
function init() {
	...
	mygrid
			.setImagePath("http://manet.informatik.rwth-aachen.de/~atlas/gadgets/sevianno/images/imgs/");
				...
				.forEachRow(function(id) {
					...
					if (authorid == userName || authorid == "admin") {
						...
						mygrid
								.cellById(id, 5)
								.setValue(
										"http://www-i5.informatik.rwth-aachen.de/~srivatsan/final/DELETE.png^delete annotations^javascript:deleteAnnotations(mygrid.getSelectedId(),mygrid.cellById(id,0).getValue(),mygrid.getRowsNum())^_self");
						console.log("test");
						mygrid
								.cellById(id, 6)
								.setValue(
										"http://www-i5.informatik.rwth-aachen.de/~srivatsan/final/update.gif^update annotations^javascript:updateAnnotations(mygrid.getSelectedId(),mygrid.cellById(id,1).getValue(),mygrid.getRowsNum())^_self");
					} else {
