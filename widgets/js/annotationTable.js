...
function init() {
	...
	mygrid
			.setImagePath("http://54.229.235.99:1337/sevianno/master/images/imgs/");
				...
				.forEachRow(function(id) {
					...
					if (authorid == userName || authorid == "admin") {
						...
						mygrid
								.cellById(id, 5)
								.setValue(
										"http://54.229.235.99:1337/sevianno/master/images/DELETE.png^delete annotations^javascript:deleteAnnotations(mygrid.getSelectedId(),mygrid.cellById(id,0).getValue(),mygrid.getRowsNum())^_self");
						console.log("test");
						mygrid
								.cellById(id, 6)
								.setValue(
										"http://54.229.235.99:1337/sevianno/master/images/update.gif^update annotations^javascript:updateAnnotations(mygrid.getSelectedId(),mygrid.cellById(id,1).getValue(),mygrid.getRowsNum())^_self");
					} else {
